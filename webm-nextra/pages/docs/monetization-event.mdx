...
- [assetScale](monetization-event-asset-scale.md) _(deprecated)_
  ...
  <Hidden>
    - [incomingPayments](monetization-event-incoming-payments.md) : A string
    containing the URL representing an incoming payment at the monetization
    receiver.
  </Hidden>
...
<BrowserCompat dataSource="monetizationevent">
