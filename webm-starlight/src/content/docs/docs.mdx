...
import Specifications from "../../components/docs/Specifications";
import BrowserCompat from "../../components/docs/BrowserCompat";
import Hidden from "../../components/docs/Hidden";
import data from "../../data/browser-compat-data/webmonetization.json";
